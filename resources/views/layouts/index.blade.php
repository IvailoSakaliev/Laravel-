...
<body>
	...
	<header>
		<div class="row" id="coverImage">
			<div class="centerHeader">
				<h1 class="">Wellcome in my site</h1>
				<a href="#headers" class="btn btn-info page-scroll" onclick="ScrollToo()">Get start</a>
			</div>
            <script>
                function ScrollToo() {
   ...
   <div class="row">
	   	<div class="container" id="id="information"">
	    	@yield('main')
	    </div>
   </div>
